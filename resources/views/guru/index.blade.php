    ...
    <div class="row mt-5 py-3">
        <div class="col-lg-12">
            ...
            <div class="d-flex justify-content-between">
                <p class="font-signika text-dark">Daftar Guru</p>
                <div>
                    <a href="{{ route('guru.create') }}" class="btn btn-sm btn-success font-14 font-poppins">Tambah Data</a>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('guru.destroy', $data->id) }}" method="POST">
                                                ...
                                                <a href="{{ route('guru.edit-password', $data->id) }}" class="btn btn-sm btn-outline-success font-poppins font-14">Ganti Password</a>
                                                <a href="{{ route('guru.edit', $data->id) }}" class="btn btn-sm btn-warning font-poppins font-14">Edit</a>
